...
import com.springboot.domain.LearnResource;
...
public class LearnResourceController {
    ...
    public ModelAndView index() {
        ...
        learnList.add(bean);
        bean = new LearnResource("官方SpriongBoot例子","官方SpringBoot例子","https://github.com/spring-projects/spring-boot/tree/master/spring-boot-samples");
        learnList.add(bean);
